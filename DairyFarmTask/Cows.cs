    ...
    public partial class Cows : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    String Query = "UPDATE CowTb values('" + CowName.Text + "' , '" + EarTag.Text + "' , '" + Color.Text + "' , '" + Breed.Text + "' , " + Convert.ToInt32(Age.Text) + " , " + Convert.ToInt32(Weight.Text) + ", '" + Pasture.Text + "') WHERE Cowid = " + key;
                    connection.SetData(Query);
